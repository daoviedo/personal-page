...
function Contact() {
  return (
    <div className="flex flex-wrap gap-2 sm:space-y-0 sm:space-x-4 justify-center items-center px-4 mb-4 text-sm font-light text-light-text-secondary dark:text-dark-text-secondary motion-preset-pop motion-delay-1500 mt-2 sm:mt-4">
      <Button
      ...
      <Button
        ...
        download
        rel="noopener noreferrer"
        className="flex justify-center items-center p-2 mx-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors motion-safe:transition-transform motion-safe:duration-300 motion-safe:ease-in-out hover:scale-110"
      >
